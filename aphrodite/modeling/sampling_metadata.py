...
class SamplingTensors:
    ...
    def from_sampling_metadata(
        ...
        *,
        ...
        for seq_group in sampling_metadata.seq_groups:
            ...
            dry_sequence_breakers += [params.dry_sequence_breakers] * n_seqs
        ...
        sampling_tensors = SamplingTensors.from_lists(
            ...
            dry_multipliers, dry_bases, dry_allowed_lengths, dry_sequence_breakers,
    ...
    def from_lists(cls, temperatures: List[float], dynatemp_mins: List[float],
                   ...
                   dry_allowed_lengths: List[int], dry_sequence_breakers: List[str],
                   sampling_seeds: List[List[int]],
