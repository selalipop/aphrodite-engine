...
class SamplingParams(
    ...
    Args:
        ...
        dry_sequence_breakers: String of token sequences that stop
            ...
            are newlines, quotes, and other structural tokens. Specified as a
            comma-separated list of quoted strings. Defaults to '"\n", ":", "\"", "*"'.
    """
    ...
    def _verify_args(self) -> None:
        ...
        if self.dry_allowed_length < 1:
            raise ValueError(
                "dry_allowed_length must be at least 1, got "
